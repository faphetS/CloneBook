        ...
        <div className="fixed inset-0 flex items-center justify-center p-4">
          <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} exit={{ opacity: 0, scale: 0.95 }} transition={{ duration: 0.2 }} className="bg-neutral-900 rounded-2xl w-full max-w-md p-6 space-y-6">
            ...
            {error ?
              ...
              :
              (
                <h2 className="text-xl font-semibold text-white text-center px-2 py-2">Edit Profile</h2>
              )}
            ...
            <div className="flex justify-end gap-2 mt-4">
              ...
              <button
                ...
                className="px-4 py-2 rounded-md bg-neutral-700 hover:bg-neutral-600 text-white transition">Cancel</button>

              <button
                onClick={handleSave}
                disabled={!!error || loading}
                className="relative px-4 py-2 rounded-md bg-[#1877F2] disabled:bg-[#3a8cff]/50 hover:bg-[#3a8cff] text-white transition flex justify-center items-center"
              >
                {loading ? (
                  <svg
